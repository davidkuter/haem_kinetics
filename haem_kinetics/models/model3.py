...
class Model3(Model2b):
    """
    Model 2b + Garnie Fig. 3 plasmepsin amount schedule s_PM(t).

    Uptake stays two-phase f_exp. Shared variable_dv_volume bookkeeping is
    unchanged. [E]_i,eff = s_PM(t) · n_E,i / V_DV(t).
    """
