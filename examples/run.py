"""Run all haem kinetics models and save comparison plots."""
...
runs = [
    ...
    ('examples/model4.png', Model4, [0.018, 0.0, 0.0, 0.0, 0.36], {}),
    ('examples/model5.png', Model5, [0.018, 0.0, 0.0, 0.0, 0.36], {}),
    ('examples/model6.png', Model6, [0.018, 0.0, 0.0, 0.0, 0.0, 0.36], {}),
